...
import ventas.backend.SQL.dao.SalePaymentMethodDao;
import ventas.backend.SQL.dto.DeskDto;
import ventas.backend.SQL.dto.SalePaymentMethodDto;
import ventas.backend.SQL.dto.SaleWithPaymentMethodEncapsulatedDto;
import ventas.backend.SQL.dto.SaleWithPaymentMethodsDto;
import ventas.backend.SQL.mappers.SalePaymentMethodMapper;
